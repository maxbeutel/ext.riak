...
#define RIAK_OBJECT_DELETED "deleted"
#define RIAK_OBJECT_DELETED_LEN strlen(RIAK_OBJECT_DELETED)
...
#define RIAK_OBJECT_HEADER_LOCATION "location"
#define RIAK_OBJECT_HEADER_LOCATION_SIZE sizeof(RIAK_OBJECT_HEADER_LOCATION) 
